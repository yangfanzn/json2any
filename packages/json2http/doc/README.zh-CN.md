...
@RM_typescript_agents:> **💡 typescript@5 说明：** 内置了 `typescript_axios@1`、`typescript_fetch@0`、`typescript_weixin@3` 三种 agent，其中微信小程序需要额外环境配置，详见 [typescript_weixin@3 配置说明](https://github.com/yangfanzn/json2any/blob/main/packages/json2http/doc/typescript-weixin.zh-CN.md)@
